...
def create_aggressive_debator(llm):
    def aggressive_node(state) -> dict:
        ...
        # decision — like the 4 reports below — is identical across all
        # rounds of this 3-way debate; it belongs in the cached static block,
        # not re-sent fresh each round.
        trader_decision = state["trader_investment_plan"]

        # Static/dynamic split for Anthropic prompt-cache breakpointing — see
        # bull_researcher.py for the rationale; concatenation reproduces the
        # exact single-string prompt this node used to build.
